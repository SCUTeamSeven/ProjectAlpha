...
class Tasks:
    ...
    def find_task(self, task_id):  # Helper function to shorten gspread find functionality
        return self.tasks.find(str(task_id), in_column=1)
...
# print("\n")
# update_info = [6, "Leavey", "210", "12/1/21", "Irvin", "{type: ‘Task Type 1’, attributes: [{id: 0, value: ’text "
#                                                        "value’}, {id: 1, value: ‘true’}, {id: 2, value: ‘false’}, "
#                                                        "{id: 3, value: ‘large text value’}]}", "active"]
# test.update_task(update_info)
# batch_update_info = [[3, "Casa", "343", "11/30/21", "Chris", "{type: ‘Task Type 1’, attributes: [{id: 0, value: ’text "
#                                                              "value’}, {id: 1, value: ‘true’}, {id: 2, "
#                                                              "value: ‘false’}, {id: 3, value: ‘large text value’}]}",
#                       "unassigned"],
#                      [7, "O'Connor", "207", "11/30/21", "Jacob", "{type: ‘Task Type 1’, attributes: [{id: 0, value: "
#                                                                  "’text value’}, {id: 1, value: ‘true’}, {id: 2, "
#                                                                  "value: ‘false’}, {id: 3, value: ‘large text "
#                                                                  "value’}]}", "active"],
#                      [8, "O'Connor", "207", "11/30/21", "Axel", "{type: ‘Task Type 1’, attributes: [{id: 0, value: "
#                                                                 "’text value’}, {id: 1, value: ‘true’}, {id: 2, "
#                                                                 "value: ‘false’}, {id: 3, value: ‘large text "
#                                                                 "value’}]}", "active"]]
